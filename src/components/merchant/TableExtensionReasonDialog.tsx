...
interface TableExtensionReasonDialogProps {
  open: boolean;
...
const predefinedReasons = [
  "Previous party running late",
  "Table cleaning in progress",
  "Busy period - limited seating",
  "Seating arrangement taking longer",
  "Staff shortage",
  "Other (please specify)"
];

export function TableExtensionReasonDialog({
  open,
  onOpenChange,
  onConfirm,
  title = "Extend Wait Time",
  description = "Select time extension and provide a reason"
}: TableExtensionReasonDialogProps) {
