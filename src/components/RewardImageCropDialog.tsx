...
async function getCroppedImg(imageSrc: string, pixelCrop: Area, rotation = 0): Promise<Blob> {
  ...
  // Output at 4:3 aspect, max 640x480
...
export function RewardImageCropDialog({ open, imageSrc, onClose, onCropComplete }: RewardImageCropDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Adjust Reward Image</DialogTitle>
        </DialogHeader>
